// @ts-nocheck — extracted from decompiled code
import { feature } from './stubs'
// feature() already imported from stubs
const AGENT_TOOL_NAME = 'AgentTool'
const TASK_OUTPUT_TOOL_NAME = 'TaskOutputTool'
const TASK_STOP_TOOL_NAME = 'TaskStopTool'
import type { PermissionRuleValue } from './permissions'
