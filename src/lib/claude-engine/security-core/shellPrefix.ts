...
// QuerySource type not needed in standalone mode
import { getFeatureValue_CACHED_MAY_BE_STALE } from './stubs'
import { logEvent } from './stubs'
// queryHaiku not available in standalone mode
import { startsWithApiErrorPrefix } from './stubs'
const memoizeWithLRU = <T extends Function>(fn: T): T => fn as T
import { jsonStringify } from './stubs'
import { asSystemPrompt } from './stubs'
