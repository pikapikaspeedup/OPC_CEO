...
import type { AgentRun, Conversation, DecisionTargetFE, Project, ModelConfig, Server, Skill, StepsData, Workflow, Rule, Workspace, TemplateSummaryFE, ResumeAction, CEOEvent } from '@/lib/types';
...
import { useDepartmentConfigs } from '@/hooks/use-department-configs';
...
export default function Home() {
  ...
  // OPC Phase 3: load department configs for all workspaces (extracted hook)
  const {
    departmentsMap,
    setDepartmentsMap,
    ...
    isOpcUnconfigured,
  } = useDepartmentConfigs(departmentWorkspaces);
